...
var ecparams = ecurve.getCurveByName('secp256k1'); //or secp256k1
...
console.log('mHash', ':', keccak256(m.toString()));
console.log(typeof (m + t));
console.log(m + t + '**************');
...
console.log('result', BigInteger.fromHex(keccak256(m + toHash)).toHex());
